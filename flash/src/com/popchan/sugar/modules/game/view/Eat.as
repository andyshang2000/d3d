...
package com.popchan.sugar.modules.game.view
{
	...
	public class Eat extends XImage
	{
		...
		public function zoomOutIn():void
		{
			var t:Eat;
			t = this;
			Tweener.addTween(this, {"time": 0.1, "scaleX": 0, "scaleY": 0, "transition": "linear", "onComplete": function():void
			{
				Tweener.addTween(t, {"time": 0.1, "scaleX": 1, "scaleY": 1, "transition": "linear"});
			}});
		}
		...
		public function zoomIn():void
		{
			this.scaleX = 0;
			this.scaleY = 0;
			Tweener.addTween(this, {"time": 0.2, "scaleX": 1, "scaleY": 1, "transition": "linear"});
		}
