...
package com.popchan.framework.utils
{
    ...
    public class ToolKit 
    {
        ...
        public static function createMovieClip(_arg_1:DisplayObjectContainer, _arg_2:Vector.<Texture>, _arg_3:int=0, _arg_4:int=0):CMovieClip
        {
            var _local_5:CMovieClip = new CMovieClip(_arg_2);
            _local_5.x = _arg_3;
            _local_5.y = _arg_4;
